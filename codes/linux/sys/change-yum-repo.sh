...
if [[ ${version} == 5 ]]; then
	...
	wget -N https://github.com/adminlove520/Linux_All_in_one/raw/main/codes/linux/sys/yum/Centos-5.repo -O /etc/yum.repos.d/CentOS-Base.repo
	...
	wget -N https://github.com/adminlove520/Linux_All_in_one/raw/main/codes/linux/sys/yum/Centos-6.repo -O /etc/yum.repos.d/CentOS-Base.repo
elif [[ ${version} == 7 ]]; then
	wget -N https://github.com/adminlove520/Linux_All_in_one/raw/main/codes/linux/sys/yum/Centos-7.repo -O /etc/yum.repos.d/CentOS-Base.repo
else

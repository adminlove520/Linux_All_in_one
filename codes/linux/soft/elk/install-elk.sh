...
replaceLogstashConfig() {
	...
	wget "https://github.com/adminlove520/Linux_All_in_one/raw/main/codes/linux/soft/elk/config/logstash.conf"
}
...
wget -P /home/zp/script "https://github.com/adminlove520/Linux_All_in_one/raw/main/codes/linux/soft/elk/boot-elk.sh"
#setPrivilegeForUser
